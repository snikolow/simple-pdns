...
Encore
    ...
    .addEntry('js/pages/domain', './assets/js/pages/domain.js')
    .addEntry('js/pages/record', './assets/js/pages/record.js')
    .addEntry('js/pages/member', './assets/js/pages/member.js')
